export default {
  ...
  Account: {
    ...
    MemberInformation: 'Personal Details',
    MyMessages: 'Recent activity',
    MyFavorite: 'Wishlist',
    MyOrder: 'My Orders',
  ...
  Forgetpassword: {
    ...
    ResetPwdTips: 'Please enter the registered email you used for registration, then click Next to continue',
  ...
  CheckOut: {
    ...
    confirm: 'Confirm',
    Total: 'Total',
    BacktoShoppingCart: 'Continue Shopping',
    Last: 'Last',
    Checkout: 'Checkout',
    Next: 'Next',
    Delivery: 'Delivery',
    ...
    PaymentProcess: 'Please proceed the payment',
